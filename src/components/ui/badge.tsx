...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 select-none",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground hover:bg-accent/50 active:bg-accent/70",
      },
    },
    defaultVariants: {
      variant: "default",
